...
var achievements = [
  ...
  //Mech
  ["--", "Started Game", "DISCRIPTION", "ach_mech_strtGame", "ASSET", "Mechanical", "UNLOCKED"], //     Started game
  ["--", "Doner", "DISCRIPTION", "ach_mech_donor", "ASSET", "Mechanical", "UNLOCKED"], //               The player has given the devs money
  ["--", "Giver", "DISCRIPTION", "ach_mech_giver", "ASSET", "Mechanical", "UNLOCKED"], //               The player has given the devs feedback that has been put in the game 
  ["--", "Exterminator", "DISCRIPTION", "ach_mech_exterm", "ASSET", "Mechanical", "UNLOCKED"], //       The player has reported a bug in the game
  ["--", "Alpha Tester", "DISCRIPTION", "ach_mech_alpha", "ASSET", "Mechanical", "UNLOCKED"], //        The player was a Alpha tester
  ["--", "Beta Tester", "DISCRIPTION", "ach_mech_beta", "ASSET", "Mechanical", "UNLOCKED"],  //         The player was a Beta tester
  //Playing
  ["--", "Level 5", "DISCRIPTION", "ach_lvl_Five", "ASSET", "Playing", "UNLOCKED"],  //                 Got to level 5
];
...
var unsortedItems = [
  ...
  ["--", "Green Paint", "DISCRIPTION", true, 1, "Common", "Customization Objects", 0], //       Colors the screen Green    (Leaves FEW patches of old color)
  ["--", "Blue Paint", "DISCRIPTION", true, 1, "Common", "Customization Objects", 0], //        Colors the screen Blue     (Leaves FEW patches of old color)
  ["--", "Purple Paint", "DISCRIPTION", true, 1, "Common", "Customization Objects", 0], //      Colors the screen Purple   (Leaves FEW patches of old color)
  ["--", "Pink Paint", "DISCRIPTION", true, 1, "Common", "Customization Objects", 0], //        Colors the screen Pink     (Leaves FEW patches of old color)
  ["--", "Black Paint", "DISCRIPTION", true, 1, "Common", "Customization Objects", 0], //       Colors the screen Black    (Leaves FEW patches of old color)

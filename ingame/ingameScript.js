...
var unsortedItems = [
  ...
  //good
  ["--", "Red Paint", "DISCRIPTION", true, 1, "Common", "School Objects", 0], //         Colors the screen Red      (Leaves patches of old color)
  ["--", "Orange Paint", "DISCRIPTION", true, 1, "Common", "School Objects", 0], //      Colors the screen Orange   (Leaves patches of old color)
  ["--", "Yellow Paint", "DISCRIPTION", true, 1, "Common", "School Objects", 0], //      Colors the screen Yellow   (Leaves patches of old color)
  ["--", "Green Paint", "DISCRIPTION", true, 1, "Common", "School Objects", 0], //       Colors the screen Green    (Leaves patches of old color)
  ["--", "Blue Paint", "DISCRIPTION", true, 1, "Common", "School Objects", 0], //        Colors the screen Blue     (Leaves patches of old color)
  ["--", "Purple Paint", "DISCRIPTION", true, 1, "Common", "School Objects", 0], //      Colors the screen Purple   (Leaves patches of old color)
  ["--", "Pink Paint", "DISCRIPTION", true, 1, "Common", "School Objects", 0], //        Colors the screen Pink     (Leaves patches of old color)
  ["--", "Black Paint", "DISCRIPTION", true, 1, "Common", "School Objects", 0], //       Colors the screen Black    (Leaves patches of old color)
  ["--", "Brown Paint", "DISCRIPTION", true, 1, "Common", "School Objects", 0], //       Colors the screen Brown    (Leaves patches of old color)
  ["--", "Gray Paint", "DISCRIPTION", true, 1, "Common", "School Objects", 0], //        Colors the screen Gray     (Leaves patches of old color)
  ["--", "White Paint", "DISCRIPTION", true, 1, "Common", "School Objects", 0], //       Colors the screen White    (Leaves patches of old color)
